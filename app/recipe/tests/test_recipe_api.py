...
def detail_url(recipe_id):
    """Create and return rcipe detail URL"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_clear_recipe_ingredients(self):
        """Test clearing a recipeingredients"""
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='palak panner')
        in1 = Ingredient.objects.create(user=self.user, name='Feta chesse')
        in2 = Ingredient.objects.create(user=self.user, name='Cotage chesse')
